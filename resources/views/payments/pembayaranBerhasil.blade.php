    ...
    <div class="my-10" x-data="{
        ...
        <div class="border bg-white shadow p-5 rounded-xl px-[70px] py-[40px] mt-32 mx-auto w-[765px]">
            ...
            <div class="flex items-stretch space-x-3">
                <a href="/users/profile-user" class="bg-red-600 w-full text-center py-3 rounded-lg font-bold text-white">Cek
                    Status Pembayaran</a>
                <a href="/field-schedule" class="bg-red-600 w-full text-center py-3 rounded-lg font-bold text-white">Pesan
                    Lagi</a>
            </div>
        </div>
    </div>
