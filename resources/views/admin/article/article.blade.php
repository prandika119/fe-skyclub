                            ...
                            <td class="py-4 px-5 text-left text-sm border-b border-gray-200 align-middle">
                                <div class="inline-flex rounded-md shadow-sm" role="group">
                                    <a :href="`/articles/${article.id}`"
                                        class="w-20 py-2 text-sm text-center font-medium text-white bg-blue-500 rounded-s-lg hover:bg-blue-600 focus:text-white">
                                        Show
                                    </a>

                                    <button @click="submitDelete(article.id)"
        ...
        function articleHandler() {
            return {
                ...
                openDeleteModal(article) {
                    console.log('Opening delete modal for article:', article);
                    this.selectedArticle = article.id;
                    this.showDeleteModal = true;
                },
                async submitDelete(articleId) {
                    try {
                    ...
                    this.fetchArticles(); // refresh data
                },
            }
        }
